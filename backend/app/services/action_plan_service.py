...
class ActionPlanService:
    ...
    def _create_from_item(
        ...
        if existing:
            ...
            existing.priority = ActionPriority(item.priority)
            existing.assigned_person = item.assigned_person or owner_name
            existing.deadline = deadline
            existing.evidence_required = item.evidence_required
